{
  ...
  "config_contexto": {
    ...
    "texto_evaluacion_inicial": "Durante la primera semana del curso se realiza una evaluación inicial mediante un cuestionario de conocimientos previos sobre electricidad básica, normativa ICT y manejo de herramientas de taller, junto con una observación directa del alumnado en una primera práctica guiada. Los resultados se emplean para ajustar el ritmo de las primeras Unidades didácticas y para detectar necesidades de apoyo o refuerzo desde el inicio, sin que en ningún caso condicionen la calificación del módulo.",
    "texto_medidas_bilingue": "Este módulo no se imparte en modalidad bilingüe. No obstante, dado que parte de la documentación técnica del sector (hojas de características, manuales de fabricantes) está disponible únicamente en inglés, se incorpora de forma transversal un pequeño glosario técnico bilingüe español-inglés de los términos más habituales de la instalación de infraestructuras de telecomunicaciones."
  },
  "config_aula": {
