...
PDF A4 vertical - Ficha individual de alumnado: datos de matrícula +
...
def generar_pdf_ficha_alumnado(info_modulo, al_id, df_al, attendance_summary=None):
    buffer = io.BytesIO()
    W, H = portrait(A4)
...
def generar_docx_ficha_alumnado(info_modulo, al_id, df_al, attendance_summary=None):
